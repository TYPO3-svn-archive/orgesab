 ...
 *
 *
 *   70: class tx_orgesab_sql_AdditionalFieldProvider implements tx_scheduler_AdditionalFieldProvider
 *
...
/**
 * Class "tx_orgesab_sql" provides procedures for update the database
 *
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/orgesab/lib/sql/class.tx_orgesab_sql.php'])) {
  include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/orgesab/lib/sql/class.tx_orgesab_sql.php']);
}
